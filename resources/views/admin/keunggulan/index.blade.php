...
@section('title', 'Why Choose Us Data')
            ...
            <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                    <h5 class="card-title">@yield('title')
                        <span>|
                            <a href="{{ route('keunggulan.create') }}" class="btn btn-outline-primary btn-sm">Tambah
                                Keunggulan
                            </a>
                        </span>
                    </h5>
                    ...
                    <table class="table table-borderless datatable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><img src="{{ asset('galeries/keunggulan/' . $p->image) }}" class="img-fluid"
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-1">
                                        <a class="btn btn-primary btn-sm rounded-circle"
                                            href="{{ route('keunggulan.edit', $p->id) }}"><i
                                                class="bi bi-pencil-fill"></i></a>
                                        <form action="{{ url('/admin/keunggulan/' . $p->id) }}" method="post"
                                            class="d-inline">
                                            @csrf
                    ...
                    <form action="{{ url('/keunggulan/{id}') }}" method="POST" class="d-inline">
                        @csrf
                        @method('delete')
    ...
    function handleDelete(id)
        {
            ...
            link.href = "{{ URL::to('delete-keunggulan') }}/" + id
            $('#danger').modal('show')
        }
</script>
