            ...
            <div class="card">
                <div class="card-body table-responsive-md">
                    <h5 class="card-title">@yield('title')
                        <span>|
                            <a href="{{ route('service.create') }}" class="btn btn-outline-primary btn-sm">Tambah
                                Layanan
                            </a>
                        </span>
                    </h5>
                    ...
                    <table class="table datatable table-responsive-md">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><img src="{{ asset('services/' . $service->image) }}" class="img-fluid"
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-danger" data-bs-toggle="modal"
                                        data-bs-target="#modaldelete({{ $service->id }})" value="{{ $service->id }}"><i
