...
@section('title', 'Edit Privacy Data')
        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="row g-3" method="post" action="{{ route('privacy.update', $privacy->id) }}"
                        ...
                        <div class="col-md-6">
                            <label for="title" class="form-label"><i class="bi bi-chat-left-text-fill"></i>
                                Title</label>
                            <input class="form-control" value="{{ $privacy->title }}" name="title" required="required"
                        ...
                        <div class="col-md-6">
                            <label for="subtitle" class="form-label"><i class="bi bi-chat-left-text-fill"></i>
                                Subtitle</label>
                            <input class="form-control" value="{{ $privacy->subtitle }}" name="subtitle"
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea type="text" name="desc" class="form-control @error('desc') is-invalid @enderror"
                                value="{{ old('desc', $privacy->desc) }}" id="task-textarea"
                                placeholder="Masukkan deskripsi">{{ old('desc', $privacy->desc) }}</textarea>
                            @error('desc')
                            <div class="invalid invalid-feedback">{{$message}}</div>
                            @enderror
                        </div>
