...
@section('title', 'Privacy & Policy Data')
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                    <h5 class="card-title">@yield('title') <span>| Privacy & Policy Table<span></h5>
                    ...
                    <table class="table table-borderless datatable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $p->title }}</td>
                                <td>{{ $p->subtitle }}</td>
                                <td>{!! \Illuminate\Support\Str::limit($p->desc, 255) !!}</td>
                                <td>
                                    <div class="d-flex align-items-center gap-1">
                                        <a class="btn btn-primary btn-sm rounded-circle"
                                            href="{{ route('privacy.edit', $p->id) }}"><i
                                                class="bi bi-pencil-fill"></i></a>
                                        <form action="{{ url('/admin/privacy/' . $p->id) }}" method="post"
                                            class="d-inline">
                                            @csrf
                    ...
                    <form action="{{ url('/privacy/{id}') }}" method="POST" class="d-inline">
                        @csrf
                        @method('delete')
    ...
    function handleDelete(id)
        {
            ...
            link.href = "{{ URL::to('delete-privacy') }}/" + id
            $('#danger').modal('show')
        }
</script>
