...
@section('title', 'Edit Heading Benefit Data')
...
<div class="pagetitle">
    ...
    <nav>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">Heading Benefit Data</li>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="row g-3" method="post"
                        action="{{ route('heading-benefit.update', $headingBenefit->id) }}"
                        ...
                        <div class="col-md-6">
                            <label for="title" class="form-label"><i class="bi bi-chat-left-text-fill"></i>
                                Judul</label>
                            <input class="form-control" value="{{ $headingBenefit->title }}" name="title"
                        ...
                        <div class="col-md-6">
                            <label for="subtitle" class="form-label"><i class="bi bi-chat-left-text-fill"></i> Sub
                                Judul</label>
                            <input class="form-control" value="{{ $headingBenefit->subtitle }}" name="subtitle"
                        ...
                        <div class="col-md-4">
                            ...
                            <img src="{{ asset('heading/benefit/' . $headingBenefit->image) }}"
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea type="text" id="task-textarea" class="form-control" id="desc" name="desc"
                                placeholder="Masukkan Deskripsi">{{ $headingBenefit->desc }}
                                </textarea>
                            @error('desc')
                            <div class="invalid invalid-feedback">{{$message}}</div>
                            @enderror
