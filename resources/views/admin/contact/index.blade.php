    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                    <h5 class="card-title">@yield('title') <span>| Contact Table</span></h5>
                    ...
                    <table class="table table-borderless datatable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $p->email }}</td>
                                <td>
                                    <iframe src="{{ $p->map }}" style="border:0;" width="100" height="100"
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-1">
                                        <a class="btn btn-primary btn-sm rounded-circle"
                                            href="{{ route('contact.edit', $p->id) }}"><i
                                                class="bi bi-pencil-fill"></i></a>
                                        <form action="{{ url('/admin/contact/' . $p->id) }}" method="post"
                                            class="d-inline">
                                            @csrf
                    ...
                    <form action="{{ url('/contact/{id}') }}" method="POST" class="d-inline">
                        @csrf
                        @method('delete')
    ...
    function handleDelete(id)
        {
            ...
            link.href = "{{ URL::to('delete-contact') }}/" + id
            $('#danger').modal('show')
        }
</script>
@endsection