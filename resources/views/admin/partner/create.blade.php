...
@section('title', 'Add Partner Data')
        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="row g-3" method="POST" action="{{ route('partner.store') }}"
                        ...
                        <div class="col-md-6">
                            <label for="name" class="form-label"><i class="bi bi-chat-left-text-fill"></i>
                                Name</label>
                            <input class="form-control" name="name" required="required" placeholder="Masukkan nama"
                                id="name">
                            @error('name')
