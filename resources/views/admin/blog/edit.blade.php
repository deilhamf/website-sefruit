            ...
            <form class="row g-3" method="POST" action="{{ Route('blog.update', $blog->id) }}"
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="title" class="form-control @error('title') is-invalid @enderror"
                        value="{{ old('title', $blog->title) }}" id="title" placeholder="Masukkan judul blog">
                    @error('title')
                ...
                <div class="col-md-6">
                    ...
                    <select type="text" class="form-control @error('category_id') is-invalid @enderror"
                        value="{{ old('category_id', $blog->category_id) }}" id="category_id" name="category_id">
                        @foreach ($categories as $category)
                        <option value="{{ $category->id }}" {{ old('category_id', $blog->category_id) == $category->id ?
                ...
                <div class="col-md-12">
                    ...
                    <textarea type="text" name="overview" class="form-control @error('overview') is-invalid @enderror"
                        value="{{ old('overview', $blog->overview) }}" id="overview"
                        placeholder="Masukkan deskripsi blog">{{ old('overview', $blog->overview) }}</textarea>
                    @error('overview')
                    <div class="invalid invalid-feedback">{{$message}}</div>
                    @enderror
                </div>
                <div class="col-md-12">
                    ...
                    <textarea type="text" name="desc" class="form-control @error('desc') is-invalid @enderror"
                        value="{{ old('desc', $blog->desc) }}" id="task-textarea"
                        placeholder="Masukkan deskripsi blog">{{ old('desc', $blog->desc) }}</textarea>
                    @error('desc')
                    <div class="invalid invalid-feedback">{{$message}}</div>
                    @enderror
                </div>
                <div class="col-md-12">
                    ...
                    <input type="file" name="image" class="form-control @error('image') is-invalid @enderror"
                        value="{{ old('image', $blog->image) }}" id="image">
                    <img src="{{ asset('blogs/' . $blog->image) }}" class="img-preview img-fluid mt-2"
                ...
                <div class="col-md-6">
                    ...
                    <textarea type="text" name="keyword" class="form-control @error('keyword') is-invalid @enderror"
                        value="{{ old('keyword', $blog->keyword) }}" id="keyword"
                        placeholder="Masukkan judul blog">{{ old('keyword', $blog->keyword) }}</textarea>
                    @error('keyword')
                    <div class="invalid invalid-feedback">{{$message}}</div>
                    @enderror
                </div>
                <div class="col-md-6">
                    ...
                    <textarea type="text" name="tags" class="form-control @error('tags') is-invalid @enderror"
                        value="{{ old('tags', $blog->tags) }}" id="tags"
                        placeholder="Masukkan judul blog">{{ old('tags', $blog->tags) }}</textarea>
                    @error('tags')
                    <div class="invalid invalid-feedback">{{$message}}</div>
                    @enderror
                </div>
