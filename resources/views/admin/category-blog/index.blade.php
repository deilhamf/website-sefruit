            ...
            <div class="card">
                <div class="card-body table-responsive-md">
                    ...
                    <h5 class="card-title">@yield('title')
                        <span>|
                            <a href="{{ route('category-blog.create') }}" class="btn btn-outline-primary btn-sm">Tambah
                                Kategori Blog
                            </a>
                        </span>
                    </h5>
                    ...
                    <table class="table datatable table-responsive-md">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ Route('category-blog.edit', $category->id) }}"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <form action="{{ Route('category-blog.destroy', $category->id) }}"
                                                        method="post">
                                                        @csrf
                                                        @method('delete')
