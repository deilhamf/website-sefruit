    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                    <h5 class="card-title">@yield('title') <span>| <a href="{{ route('testi.create') }}"
                                class="btn btn-outline-primary btn-sm">Tambah Testimoni</a></span></h5>
                    <table class="table table-borderless datatable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><img src="{{ asset('galeries/testimonial/' . $p->image) }}" class="img-fluid"
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-1">
                                        <a class="btn btn-primary btn-sm rounded-circle"
                                            href="{{ route('testi.edit', $p->id) }}"><i
                                                class="bi bi-pencil-fill"></i></a>
                                        <form action="{{ url('/admin/testi/', $p->id) }}" method="post"
                                            class="d-inline">
                                            @csrf
                    ...
                    <form action="{{ url('/testi/{id}') }}" method="POST" class="d-inline">
                        @csrf
                        @method('delete')
    ...
    function handleDelete(id)
        {
            ...
            link.href = "{{ URL::to('delete-testi') }}/" + id
            $('#danger').modal('show')
        }
</script>
