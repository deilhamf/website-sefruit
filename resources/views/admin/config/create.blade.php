        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="row g-3" method="POST" action="{{ route('config.store') }}"
                        ...
                        <div class="col-md-4">
                            <label for="logo" class="form-label"><i class="bi bi-image-fill"></i> Upload Logo</label>
                        ...
                        <div class="col-md-6">
                            <label for="copyright1" class="form-label"><i class="bi bi-chat-left-text-fill"></i>
                                Copyright #1</label>
                            <input class="form-control" name="copyright1" required="required"
                                placeholder="Masukkan Copyright" id="copyright1">
                            @error('copyright1')
                            <div class="invalid invalid-feedback">{{$message}}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            <label for="copyright1" class="form-label"><i class="bi bi-chat-left-text-fill"></i>
                                Copyright #2</label>
                            <input class="form-control" name="copyright2" required="required"
                                placeholder="Masukkan Copyright" id="copyright2">
                            @error('copyright2')
                            <div class="invalid invalid-feedback">{{$message}}</div>
                            @enderror
                        </div>
