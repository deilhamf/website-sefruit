...
<div class="pagetitle">
    ...
    <nav>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">About Data</li>
                    ...
                    <form class="row g-3" method="POST" action="{{ route('about.store') }}"
                        ...
                        <div class="col-md-4">
                            <label for="tahun" class="form-label"><i class="bi bi-chat-left-text-fill"></i>
                                Tahun</label>
                            <input class="form-control" name="tahun" required="required" placeholder="Masukkan tahun"
                                id="tahun">
                            @error('tahun')
                            <div class="invalid invalid-feedback">{{$message}}</div>
                            @enderror
                        ...
                        <div class="col-md-4">
                            <label for="image3" class="form-label"><i class="bi bi-image3-fill"></i> Upload
                                Gambar</label>
